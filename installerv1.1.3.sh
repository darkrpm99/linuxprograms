...
# version 1.1.3 19/12/2021
# add more software,DB Browser for SQLite,Filezilla,Firefox
# added installer for lastest kernel 5.15.10
# optimize code
...
# remove snap store and install gnome software 
...
sudo add-apt-repository -y ppa:linuxgndu/sqlitebrowser -y
sudo apt update
...
# Descargar Ultimo Kernel 5.15.10

sudo wget -c https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15.10/amd64/linux-headers-5.15.10-051510-generic_5.15.10-051510.202112171031_amd64.deb
sudo wget -c https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15.10/amd64/linux-headers-5.15.10-051510_5.15.10-051510.202112171031_all.deb
sudo wget -c https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15.10/amd64/linux-image-unsigned-5.15.10-051510-generic_5.15.10-051510.202112171031_amd64.deb
sudo wget -c https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15.10/amd64/linux-modules-5.15.10-051510-generic_5.15.10-051510.202112171031_amd64.deb
sudo dpkg -i *.deb
