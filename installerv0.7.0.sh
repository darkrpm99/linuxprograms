...
# version 0.7.0 19/01/2021
# add more software and fix errors 
# added installer for lastest kernel 5.10.8
# optimize code
...
# Descargar Ultimo Kernel 5.10.8
sudo wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.10.8/amd64/linux-headers-5.10.8-051008-generic_5.10.8-051008.202101171440_amd64.deb
sudo wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.10.8/amd64/linux-image-unsigned-5.10.8-051008-generic_5.10.8-051008.202101171440_amd64.deb
sudo wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.10.8/amd64/linux-modules-5.10.8-051008-generic_5.10.8-051008.202101171440_amd64.deb
sudo wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.10.8/amd64/linux-headers-5.10.8-051008_5.10.8-051008.202101171440_all.deb
